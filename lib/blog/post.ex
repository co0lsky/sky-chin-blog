defmodule Blog.Blog.Post do
  @moduledoc false
  @enforce_keys [:id, :author, :title, :body, :description, :featureimage, :tags, :date]
  defstruct [:id, :author, :title, :body, :description, :featureimage, :tags, :date]
  ...
  defp parse_attr(:featureimage, value),
    do: String.trim(value)
